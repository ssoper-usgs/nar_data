...
test_that("pesticide sites summary has the correct columns", {
	expect_has_names(pestsites, c(
	  "SITE_QW_ID","SITE_QW_NAME","SITE_FLOW_ID","SITE_FLOW_NAME","SITE_ABB","DA","SITE_TYPE","STATE","min_samp","AQ1","AQ2","AQ3",
	  ...
	  "NDETS_NEW","NDETS_3","NDETS_HH","NDETS_AQ","N_HH","N_AQ","NDETS_HH3","NDETS_AQ3","N_HH3","N_NUTS","N_NUTS_DET","N_NUTS_DET_HH","N_NUTS_DET_AQ","N_NUT_HH","PLOT"
	))
})

test_that("pesticide site's columns are correctly typed", {
	result <- validate::check_that(pestsites,
		is.double(c(DA,min_samp,PERC_HH,PERC_AQ,PERC_HH3,PERC_AQ3,PERC_HH_OLD,PERC_AQ_OLD,N_OLD_AVE,PERC1_NEW,PERC1_3,PERC1_OLD,PERC1_NEW_COM,PERC1_3_COM,
		            ...
		            PERC10_NEW,PERC10_3,PERC10_OLD,PERC10_NEW_COM,PERC10_3_COM,PERC10_OLD_COM,NSAMP10_OLD,N_NUTS,N_NUTS_DET,N_NUTS_DET_HH,N_NUTS_DET_AQ
		            )),
		is.character(c(SITE_QW_ID,SITE_QW_NAME,SITE_FLOW_ID,SITE_FLOW_NAME,SITE_ABB,SITE_TYPE,STATE,AQ1,AQ2,AQ3,
